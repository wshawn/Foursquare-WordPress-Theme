...
get_header(); ?>
    ...
    <div class="row">
                        ...
                        <div class="contact-meta row">
                            ...
                            <div class="col1 span3 pull-left">
                                ...
                                <?php if (get_post_meta($post->ID, "_email", true)) { ?>
                                    <div class="email">
                                        <p><a class="email"
                                              href="mailto:<?php echo get_post_meta($post->ID, "_email", true); ?>"><?php echo get_post_meta($post->ID, "_email", true); ?></a>
                                        </p>
                                    </div><!--end email-->
                            ...
                            <div class="col2 span3 pull-right">
                                ...
                                <?php if (get_post_meta($post->ID, "_facebook", true)) { ?>
                                    <div class="facebook">
                                        <p><a href="http://<?php echo get_post_meta($post->ID, "_facebook", true); ?>">Follow
                                                on Facebook</a></p>
                                    </div><!--end facebook-->
                                ...
                                <?php if (get_post_meta($post->ID, "_twitter", true)) { ?>
                                    <div class="twitter">
                                        <p>
                                            <a href="http://twitter.com/<?php echo get_post_meta($post->ID, "_twitter", true); ?>"
                                               target="_blank">@<?php echo get_post_meta($post->ID, "_twitter", true); ?></a>
                                        </p>
                                    </div>
        ...
        <!--end blog-->
        <?php include ('sidebar-single-staff.php'); ?>
    </div><!--end row-->
